	...
	, m_tagScene(TAG_SCENE::TAG_NONE)
{
...

	{
		...
		image->Init(VGet(880.0f, 200.0f, 0.0f), VGet(0.5f, 0.5f, 0.5f), 0.0f, "data/rank/ranking_1.png");
	...
	}
	{
		Object* obj = new Object;
		auto image = obj->AddComponent<Image>();
		image->Init(VGet(400.0f, 200.0f, 0.0f), VGet(0.4f, 0.4f, 0.4f), 0.0f, "data/rank/ranking_2.png");
		obj->AddComponent<Rank>();
		m_pObjectLists.push_back(obj);
	}
	{
		Object* obj = new Object;
		auto image = obj->AddComponent<Image>();
		image->Init(VGet(1400.0f, 200.0f, 0.0f), VGet(0.3f, 0.3f, 0.3f), 0.0f, "data/rank/ranking_3.png");
		obj->AddComponent<Rank>();
		m_pObjectLists.push_back(obj);
	}
	...
	for (auto i = 0; i < 6; i++)
	{
		...
		tomato->Init(VGet(i * 2, 0.0f, -20.0f), VGet(0.0f, 0.0f, 0.0f), VGet(0.02f, 0.02f, 0.02f));
		m_pObjectLists.push_back(obj);
	}
